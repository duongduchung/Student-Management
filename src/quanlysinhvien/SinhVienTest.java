...
public class SinhVienTest {
	...
	public static void printMenu() {
		...
		System.out.printf("\n| %-90s %7s", "4. Tìm kiếm tuyến tính theo tổng điểm.", "|");
		System.out.printf("\n| %-90s %7s", "5. Sửa tên sinh viên có mã được nhập từ bàn phím.", "|");
		System.out.printf("\n| %-90s %7s", "6. Xóa sinh viên có mã sinh viên được nhập từ bàn phím.", "|");
		System.out.printf("\n| %-90s %7s", "0. Kết thúc.", "|");
		printLine();
	}
		...
		try {
			...
			do {
				...
				case 2: {
					if (n.getN() == 0) {
						System.out.println(
								"Chưa có sinh viên nào trong danh sách bạn hãy chọn menu 1 để nhập các thông tin cho sinh viên.");
					} else {
				...
				case 4: {
					if (n.getN() == 0) {
						...
						ThaoTac.findID(sinhVien, n.getN());
					}
